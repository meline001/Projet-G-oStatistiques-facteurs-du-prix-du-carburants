...
# Sélectionner les lignes ou la colonne 'PrixNom' est égale à 'Gazole' pour le globale
...
# Selectionner les lignes ou la colonne 'PrixNom' est egale a 'SP98' cas globale
